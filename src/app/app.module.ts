...
import { LandingPageHomeLinksComponent } from './pages/landing-page/home-links/home-links.component';
import { LandingPageHeaderComponent } from './pages/landing-page/header/header.component';
import { LandingPageBannerComponent } from './pages/landing-page/banner/banner.component';
import { LandingPageLocationsComponent } from './pages/landing-page/locations/locations.component';
import { LandingPageSearchByAddressComponent } from './pages/landing-page/search-by-address/search-by-address.component';
import { LandingPageStoreComponent } from './pages/landing-page/store/store.component';
import { LandingPageFooterComponent } from './pages/landing-page/footer/footer.component';
import { LandingPageStorelocationsComponent } from './pages/landing-page/store-locations/store-locations.component';
...
@NgModule({
  declarations: [
    ...
    LandingPageHomeLinksComponent,
    LandingPageHeaderComponent,
    LandingPageBannerComponent,
    LandingPageLocationsComponent,
    LandingPageSearchByAddressComponent,
    LandingPageStoreComponent,
    LandingPageFooterComponent,
    LandingPageStorelocationsComponent,
    HeaderComponent,
    FooterComponent,
    HomepageComponent,
    AboutusComponent,
  ...
  imports: [
    ...
    AgmCoreModule.forRoot({
      apiKey: 'AIzaSyBHeb0qFm7O491EywXGQFnhsCiqbOkagbU',
